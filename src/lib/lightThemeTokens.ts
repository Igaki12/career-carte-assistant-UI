...
export const lightTopLine = 'linear(104deg, transparent 0%, rgba(75, 85, 99, 0.12) 18%, rgba(31, 41, 55, 0.76) 32%, rgba(75, 85, 99, 0.38) 70%, transparent 100%)';
export const lightBottomLine = 'linear(112deg, transparent 0%, rgba(156, 163, 175, 0.16) 20%, rgba(31, 41, 55, 0.48) 31%, rgba(75, 85, 99, 0.30) 72%, transparent 100%)';
