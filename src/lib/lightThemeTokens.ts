...
export const lightTopLine = 'linear(104deg, transparent 0%, rgba(75, 85, 99, 0.10) 9%, rgba(31, 41, 55, 0.74) 17%, transparent 21%, rgba(156, 163, 175, 0.30) 28%, rgba(75, 85, 99, 0.58) 39%, rgba(31, 41, 55, 0.76) 56%, transparent 61%, rgba(75, 85, 99, 0.46) 74%, transparent 100%)';
export const lightBottomLine = 'linear(112deg, transparent 0%, rgba(156, 163, 175, 0.20) 12%, rgba(75, 85, 99, 0.46) 20%, transparent 26%, rgba(31, 41, 55, 0.38) 38%, rgba(156, 163, 175, 0.52) 49%, transparent 57%, rgba(75, 85, 99, 0.34) 79%, transparent 100%)';
